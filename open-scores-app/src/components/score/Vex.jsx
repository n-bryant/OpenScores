...
class VFDisplay extends Component {
    ...
    componentDidMount() {
        ...
        function setLibrary(key, changing) {
            ...
            //major triads
            let C5 = new VF.StaveNote({
                keys: [
                    'C/4', 'E/4', 'G/4'
                ],
                duration: duration
            });
            let Cs5 = new VF.StaveNote({
                keys: [
                    'C#/4', 'E#/4', 'G#/4'
                ],
                duration: duration
            });
            let Df5 = new VF.StaveNote({
                keys: [
                    'Db/4', 'F/4', 'Ab/4'
                ],
                duration: duration
            });
            let D5 = new VF.StaveNote({
                keys: [
                    'D/4', 'F#/4', 'A/4'
                ],
                duration: duration
            });
            let Ds5 = new VF.StaveNote({
                keys: [
                    'D#/4', 'F##/4', 'A#/4'
                ],
                duration: duration
            });
            let Ef5 = new VF.StaveNote({
                keys: [
                    'Eb/4', 'G/4', 'Bb/4'
                ],
                duration: duration
            });
            let E5 = new VF.StaveNote({
                keys: [
                    'E/4', 'G#/4', 'B/4'
                ],
                duration: duration
            });
            let F5 = new VF.StaveNote({
                keys: [
                    'F/4', 'A/4', 'C/5'
                ],
                duration: duration
            });
            let Fs5 = new VF.StaveNote({
                keys: [
                    'F#/4', 'A#/4', 'C#/5'
                ],
                duration: duration
            });
            let Gf5 = new VF.StaveNote({
                keys: [
                    'Gb/4', 'Bb/4', 'Db/5'
                ],
                duration: duration
            });
            let G5 = new VF.StaveNote({
                keys: [
                    'G/4', 'B/4', 'D/5'
                ],
                duration: duration
            });
            let Gs5 = new VF.StaveNote({
                keys: [
                    'G#/4', 'B#/4', 'D#/5'
                ],
                duration: duration
            });
            let Af5 = new VF.StaveNote({
                keys: [
                    'Ab/4', 'C/5', 'Eb/5'
                ],
                duration: duration
            });
            let A5 = new VF.StaveNote({
                keys: [
                    'A/4', 'C#/5', 'E/5'
                ],
                duration: duration
            });
            let As5 = new VF.StaveNote({
                keys: [
                    'A#/4', 'C##/5', 'E#/5'
                ],
                duration: duration
            });
            let Bf5 = new VF.StaveNote({
                keys: [
                    'Bb/4', 'D/5', 'F/5'
                ],
                duration: duration
            });
            let B5 = new VF.StaveNote({
                keys: [
                    'B/4', 'D#/5', 'F#/5'
                ],
                duration: duration
            ...
            //minor triads
            let Cm5 = new VF.StaveNote({
                keys: [
                    'C/4', 'Eb/4', 'G/4'
                ],
                duration: duration
            });
            let Csm5 = new VF.StaveNote({
                keys: [
                    'C#/4', 'E/4', 'G#/4'
                ],
                duration: duration
            });
            let Dfm5 = new VF.StaveNote({
                keys: [
                    'Db/4', 'Fb/4', 'Ab/4'
                ],
                duration: duration
            });
            let Dm5 = new VF.StaveNote({
                keys: [
                    'D/4', 'F/4', 'A/4'
                ],
                duration: duration
            });
            let Dsm5 = new VF.StaveNote({
                keys: [
                    'D#/4', 'F#/4', 'A#/4'
                ],
                duration: duration
            });
            let Efm5 = new VF.StaveNote({
                keys: [
                    'Eb/4', 'Gb/4', 'Bb/4'
                ],
                duration: duration
            });
            let Em5 = new VF.StaveNote({
                keys: [
                    'E/4', 'G/4', 'B/4'
                ],
                duration: duration
            });
            let Fm5 = new VF.StaveNote({
                keys: [
                    'F/4', 'Ab/4', 'C/5'
                ],
                duration: duration
            });
            let Fsm5 = new VF.StaveNote({
                keys: [
                    'F#/4', 'A/4', 'C#/5'
                ],
                duration: duration
            });
            let Gfm5 = new VF.StaveNote({
                keys: [
                    'Gb/4', 'Bbb/4', 'Db/5'
                ],
                duration: duration
            });
            let Gm5 = new VF.StaveNote({
                keys: [
                    'G/4', 'Bb/4', 'D/5'
                ],
                duration: duration
            });
            let Gsm5 = new VF.StaveNote({
                keys: [
                    'G#/4', 'B/4', 'D#/5'
                ],
                duration: duration
            });
            let Afm5 = new VF.StaveNote({
                keys: [
                    'Ab/4', 'Cb/5', 'Eb/5'
                ],
                duration: duration
            });
            let Am5 = new VF.StaveNote({
                keys: [
                    'A/4', 'C/5', 'E/5'
                ],
                duration: duration
            });
            let Asm5 = new VF.StaveNote({
                keys: [
                    'A#/4', 'C#/5', 'E#/5'
                ],
                duration: duration
            });
            let Bfm5 = new VF.StaveNote({
                keys: [
                    'Bb/4', 'Db/5', 'F/5'
                ],
                duration: duration
            });
            let Bm5 = new VF.StaveNote({
                keys: [
                    'B/4', 'D/5', 'F#/5'
                ],
                duration: duration
            ...
            //Major seven chords
            let CMaj7 = new VF.StaveNote({
                keys: [
                    'C/4', 'E/4', 'G/4', 'B/4'
                ],
                duration: duration
            });
            let CsMaj7 = new VF.StaveNote({
                keys: [
                    'C#/4', 'E#/4', 'G#/4', 'B#/4'
                ],
                duration: duration
            });
            let DfMaj7 = new VF.StaveNote({
                keys: [
                    'Db/4', 'F/4', 'Ab/4', 'C/5'
                ],
                duration: duration
            });
            let DMaj7 = new VF.StaveNote({
                keys: [
                    'D/4', 'F#/4', 'A/4', 'C#/5'
                ],
                duration: duration
            });
            let DsMaj7 = new VF.StaveNote({
                keys: [
                    'D#/4', 'F##/4', 'A#/4', 'C##/5'
                ],
                duration: duration
            });
            let EfMaj7 = new VF.StaveNote({
                keys: [
                    'Eb/4', 'G/4', 'Bb/4', 'D/5'
                ],
                duration: duration
            });
            let EMaj7 = new VF.StaveNote({
                keys: [
                    'E/4', 'G#/4', 'B/4', 'D#/5'
                ],
                duration: duration
            });
            let FMaj7 = new VF.StaveNote({
                keys: [
                    'F/4', 'A/4', 'C/5', 'E/5'
                ],
                duration: duration
            });
            let FsMaj7 = new VF.StaveNote({
                keys: [
                    'F#/4', 'A#/4', 'C#/5', 'E#/5'
                ],
                duration: duration
            });
            let GfMaj7 = new VF.StaveNote({
                keys: [
                    'Gb/4', 'Bb/4', 'Db/5', 'F/5'
                ],
                duration: duration
            });
            let GMaj7 = new VF.StaveNote({
                keys: [
                    'G/4', 'B/4', 'D/5', 'F#/5'
                ],
                duration: duration
            });
            let GsMaj7 = new VF.StaveNote({
                keys: [
                    'G#/4', 'B#/4', 'D#/5', 'F##/5'
                ],
                duration: duration
            });
            let AfMaj7 = new VF.StaveNote({
                keys: [
                    'Ab/4', 'C/5', 'Eb/5', 'G/5'
                ],
                duration: duration
            });
            let AMaj7 = new VF.StaveNote({
                keys: [
                    'A/4', 'C#/5', 'E/5', 'G#/5'
                ],
                duration: duration
            });
            let AsMaj7 = new VF.StaveNote({
                keys: [
                    'A#/4', 'C##/5', 'E#/5', 'G##/5'
                ],
                duration: duration
            });
            let BfMaj7 = new VF.StaveNote({
                keys: [
                    'Bb/4', 'D/5', 'F/5', 'A/5'
                ],
                duration: duration
            });
            let BMaj7 = new VF.StaveNote({
                keys: [
                    'B/4', 'D#/5', 'F#/5', 'A#/5'
                ],
                duration: duration
            ...
            //minor seven chords
            let Cmin7 = new VF.StaveNote({
                keys: [
                    'C/4', 'Eb/4', 'G/4', 'Bb/4'
                ],
                duration: duration
            });
            let Csmin7 = new VF.StaveNote({
                keys: [
                    'C#/4', 'E/4', 'G#/4', 'B/4'
                ],
                duration: duration
            });
            let Dfmin7 = new VF.StaveNote({
                keys: [
                    'Db/4', 'Fb/4', 'Ab/4', 'Cb/5'
                ],
                duration: duration
            });
            let Dmin7 = new VF.StaveNote({
                keys: [
                    'D/4', 'F/4', 'A/4', 'C/5'
                ],
                duration: duration
            });
            let Dsmin7 = new VF.StaveNote({
                keys: [
                    'D#/4', 'F#/4', 'A#/4', 'C#/5'
                ],
                duration: duration
            });
            let Efmin7 = new VF.StaveNote({
                keys: [
                    'Eb/4', 'Gb/4', 'Bb/4', 'Db/5'
                ],
                duration: duration
            });
            let Emin7 = new VF.StaveNote({
                keys: [
                    'E/4', 'G/4', 'B/4', 'D/5'
                ],
                duration: duration
            });
            let Fmin7 = new VF.StaveNote({
                keys: [
                    'F/4', 'Ab/4', 'C/5', 'Eb/5'
                ],
                duration: duration
            });
            let Fsmin7 = new VF.StaveNote({
                keys: [
                    'F#/4', 'A/4', 'C#/5', 'E/5'
                ],
                duration: duration
            });
            let Gfmin7 = new VF.StaveNote({
                keys: [
                    'Gb/4', 'Bbb/4', 'Db/5', 'Fb/5'
                ],
                duration: duration
            });
            let Gmin7 = new VF.StaveNote({
                keys: [
                    'G/4', 'Bb/4', 'D/5', 'F/5'
                ],
                duration: duration
            });
            let Gsmin7 = new VF.StaveNote({
                keys: [
                    'G#/4', 'B/4', 'D#/5', 'F#/5'
                ],
                duration: duration
            });
            let Afmin7 = new VF.StaveNote({
                keys: [
                    'Ab/4', 'Cb/5', 'Eb/5', 'Gb/5'
                ],
                duration: duration
            });
            let Amin7 = new VF.StaveNote({
                keys: [
                    'A/4', 'C/5', 'E/5', 'G/5'
                ],
                duration: duration
            });
            let Asmin7 = new VF.StaveNote({
                keys: [
                    'A#/4', 'C#/5', 'E#/5', 'G#/5'
                ],
                duration: duration
            });
            let Bfmin7 = new VF.StaveNote({
                keys: [
                    'Bb/4', 'Db/5', 'F/5', 'Ab/5'
                ],
                duration: duration
            });
            let Bmin7 = new VF.StaveNote({
                keys: [
                    'B/4', 'D/5', 'F#/5', 'A/5'
                ],
                duration: duration
        ...
        function drawScore() {
            ...
            for (let i = 0; i < score.measures.length; i++) {
                ...
                score.ties.forEach(function(tie) {
                    tie.vfTie.setContext(context).draw()
                });
            }
        }
        ...
        function addAccidental(accidental) {
            selectedNote = new VF.StaveNote({clef: score.clef, keys: selectedNote.keys, duration: duration}).addAccidental(0, new VF.Accidental(accidental));
        ...
        function changePitch(key) {
            ...
            if (currentPitch === noteVals.length - 1 && key === 'up') {
                ...
                key === 'up'
                    ? newPitch = noteVals[currentPitch + 1]
                    : newPitch = noteVals[currentPitch - 1];
            }
        ...
        function tieNotes() {
            if (firstTie) {
                ...
                newTie.vfTie = new VF.StaveTie({first_note: score.measures[barIndex].notes[barNoteIndex], last_note: score.measures[barIndex].notes[barNoteIndex], first_indices: 0, last_indices: 0});
                ...
                tieExtension.vfTie = new VF.StaveTie({first_note: newestTie.vfTie.first_note, last_note: score.measures[barIndex].notes[barNoteIndex], first_indices: 0, last_indices: 0});
