...
class Score extends Component {
  // on title hover, display edit icon
  // on title click, toggle edit-title-form
  // on edit-title-form submit, update title prop and display new value
  processForm(event) {
      ...
      <section className="score-wrapper">
        <div className="score-container">
          <div className="title-container">
            ...
            {/* TITLE ISN'T RECOGNIZING PROP VALUE */}
